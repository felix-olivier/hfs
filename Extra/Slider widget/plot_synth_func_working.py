...
def plot_synth_func_working(Ju, Jl, wavenrJ, Au, Bu, Al, Bl):
...
#                
    ...
    #print(transition_index) # for testing
...
#####################EXTRA###################
    ...
    therange=np.arange((min(wavenr)-0.87),(max(wavenr)+0.87+0.005),0.005)
...
#    plt.show()
    ...
    return therange, yvalues, E_Fu, E_Fl, E_Fu1, E_Fu2, E_Fl1, E_Fl2, E_Fl3, E_Fl4

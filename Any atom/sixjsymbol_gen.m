function I=sixjsymbol_gen(j1, j3, l1, l3, Iqnr)
%Calculate sixjsymbol with j2=7/2 and l2=1.


j2=Iqnr;% % % % j2=7/2;% for scandium
l2=1;
A=delta6j_gen(j1,j2,j3)*delta6j_gen(j1,l2,l3)*delta6j_gen(l1,j2,l3)*delta6j_gen(l1,l2,j3);

function [delAus,delBus,delAls,delBls]=determine_delta_gen(rms,MaxIOBS,Ju,Jl,wavenrJ, Au, Bu, Al, Bl,lock, Iqnr)
...
%error is gaussian with rms as standard deviation.
    ...
    [ABfit,~]=fitpure_gen(wavenumbers,intensity,Ju,Jl,wavenrJ,Au*1.1,Bu*1.1,Al*1.1,Bl*1.1, lock, Iqnr); % small ofset in initial values
    saveAB(:,i)=ABfit;

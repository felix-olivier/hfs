function [warnings, HF_constants,HF_uncert,lineprop, x,wavenrstotest, Imod]=LSQcurvefit_noread_gen(Ju,Jl,wavenrJ,Au,Bu,Al,Bl, data, lock, uncert,letplot, Iqnr, figureindex)

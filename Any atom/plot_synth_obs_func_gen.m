function [translist]=plot_synth_obs_func_gen(Ju, Jl, wavenrJ, Au, Bu, Al, Bl, figureindex, data, Iqnr)
%This function plots both an FTS observed transition and a modelled versionIqnr
...
%adjusted recently to plot only IOBS, uncomment some things!!
...
Itot=0.15+(2.3*Itot*0.4/2.7); %cmment ut ater
...
% hold on
plot(wavenrOBS,IOBS, 'r.','LineWidth',lw,'MarkerSize',msz)
hold on
